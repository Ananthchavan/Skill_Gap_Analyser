...
- **AI-generated weekly & final quizzes** to test and reinforce your knowledge
...
- **Weekly Mastery Quiz** — unlocks after completing 100% of a week's tasks
- **Final Roadmap Quiz** — a comprehensive cumulative assessment unlocked upon finishing all weeks
- Questions are **auto-generated by Gemini AI** based on the specific week's topics and tasks
- Multiple-choice format with **instant scoring** and percentage results
- **Score tracking** per week, persisted to your analysis profile
- **Quiz Review Page** — revisit every question, your answer, and the correct answer after submission
- Quiz data (questions, user answers, scores) is stored in MongoDB for future reference
...
> More exciting features are planned. Stay tuned!

- 📊 **Readiness Score** — an overall role-readiness percentage generated after the final quiz
- 🏅 **Completion Certificate** — downloadable certificate upon passing the final quiz
- 🔄 **Adaptive Questions** — harder follow-up questions when answers are correct
...
│   │   │   ├── QuizPage.jsx          # Weekly & final quiz with AI-generated questions
│   │   │   └── QuizReviewPage.jsx    # Post-quiz review of answers & scores
...
| `POST` | `/api/analysis/:id/quiz/generate` | ✅ | Generate AI quiz for a specific week (or final) |
| `PATCH` | `/api/analysis/:id/quiz-score` | ✅ | Save or update quiz score, questions & answers |
